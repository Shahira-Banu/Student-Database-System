...
def DisplayForm():
    ...
    display_screen.title("Student DataBase System")
    global tree
    global SEARCH
    ...
    #label for heading
    lbl_text = Label(TopViewForm, text="Student DataBase System", font=('Times New Roman', 18), width=600,bg="#1C2833",fg="white")
